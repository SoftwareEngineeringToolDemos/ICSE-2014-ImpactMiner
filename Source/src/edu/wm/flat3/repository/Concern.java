...
public class Concern implements Comparable<Concern>
{
	...
	{
		return verifyCodeModelExists(repository, javaElement);
	}
	
	public static boolean verifyCodeModelExists(ConcernRepository repository, final IJavaElement javaElement)
	{
