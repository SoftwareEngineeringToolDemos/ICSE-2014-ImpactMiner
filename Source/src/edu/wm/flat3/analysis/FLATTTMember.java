...
/*
	...
	public boolean equals(Object obj) {
		if (obj instanceof FLATTTMember){
			FLATTTMember other = (FLATTTMember) obj;
	...
	public String getRankString(){return "" + rank;}
	public int getRank(){return rank;}
	public void setRank(int r){rank = r;}
	
	public FLATTTMember copy(){
		FLATTTMember toReturn = new FLATTTMember(this.nodeMember);
		toReturn.mark = this.mark;
		toReturn.node = this.node;
		toReturn.probability = this.probability;
		toReturn.redoHistory = this.redoHistory;
		toReturn.undoHistory = this.undoHistory;
		return toReturn;
	}
}
